...
class BallToBoxCollisionTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.balls.append(Ball(150, Vec2D(200, 100), Vec2D(50, 50), False))
        ...
        self.balls.append(Ball(150, Vec2D(300, 100), Vec2D(-50, 50), False))
        self.results.append((Vec2D(300, 0), Vec2D(0, -1)))
        self.balls.append(Ball(150, Vec2D(450, 100), Vec2D(50, 50), False))
        self.results.append((Vec2D(450, 17.16), Vec2D(0, -1)))
        self.balls.append(Ball(150, Vec2D(450, 100), Vec2D(-50, 50), False))
        self.results.append((Vec2D(450, 17.16), Vec2D(0, -1)))
        self.balls.append(Ball(150, Vec2D(450, 150), Vec2D(50, 50), False))
        ...
        self.balls.append(Ball(150, Vec2D(500, 150), Vec2D(-50, 50), False))
        self.results.append((Vec2D(582.84, 150), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(500, 150), Vec2D(-50, -50), False))
        self.results.append((Vec2D(582.84, 150), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(500, 300), Vec2D(-50, 50), False))
        self.results.append((Vec2D(600, 300), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(500, 300), Vec2D(-50, -50), False))
        self.results.append((Vec2D(600, 300), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(500, 450), Vec2D(-50, 50), False))
        self.results.append((Vec2D(582.84, 450), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(500, 450), Vec2D(-50, -50), False))
        self.results.append((Vec2D(582.84, 450), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(450, 450), Vec2D(-50, 50), False))
        ...
        self.balls.append(Ball(150, Vec2D(450, 500), Vec2D(-50, -50), False))
        self.results.append((Vec2D(450, 582.84), Vec2D(0, -1)))
        self.balls.append(Ball(150, Vec2D(450, 500), Vec2D(50, -50), False))
        self.results.append((Vec2D(450, 582.84), Vec2D(0, -1)))
        self.balls.append(Ball(150, Vec2D(300, 500), Vec2D(-50, -50), False))
        self.results.append((Vec2D(300, 600), Vec2D(0, -1)))
        self.balls.append(Ball(150, Vec2D(300, 500), Vec2D(50, -50), False))
        self.results.append((Vec2D(300, 600), Vec2D(0, -1)))
        self.balls.append(Ball(150, Vec2D(150, 500), Vec2D(-50, -50), False))
        self.results.append((Vec2D(150, 582.84), Vec2D(0, -1)))
        self.balls.append(Ball(150, Vec2D(150, 500), Vec2D(50, -50), False))
        self.results.append((Vec2D(150, 582.84), Vec2D(0, -1)))
        self.balls.append(Ball(150, Vec2D(150, 450), Vec2D(-50, -50), False))
        ...
        self.balls.append(Ball(150, Vec2D(100, 450), Vec2D(50, -50), False))
        self.results.append((Vec2D(17.16, 450), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(100, 450), Vec2D(50, 50), False))
        self.results.append((Vec2D(17.16, 450), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(100, 300), Vec2D(50, -50), False))
        self.results.append((Vec2D(0, 300), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(100, 300), Vec2D(50, 50), False))
        self.results.append((Vec2D(0, 300), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(100, 150), Vec2D(50, -50), False))
        self.results.append((Vec2D(17.16, 150), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(100, 150), Vec2D(50, 50), False))
        self.results.append((Vec2D(17.16, 150), Vec2D(-1, 0)))
        self.balls.append(Ball(150, Vec2D(150, 150), Vec2D(50, -50), False))
        ...
        self.balls.append(Ball(150, Vec2D(150, 100), Vec2D(50, 50), False))
        self.results.append((Vec2D(150, 17.16), Vec2D(0, -1)))
        self.balls.append(Ball(150, Vec2D(150, 100), Vec2D(-50, 50), False))
        self.results.append((Vec2D(150, 17.16), Vec2D(0, -1)))
        self.balls.append(Ball(150, Vec2D(0, 0), Vec2D(50, 0), False))
